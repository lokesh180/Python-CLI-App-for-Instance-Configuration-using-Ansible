#!/usr/bin/env python3
"""
The Test cases were implemented in this code.
This application will perform the below tasks and tests:
...
def main():
    ...
    play_test = Play().load(play_book_test, variable_manager=variable_manager, loader=loader)

   #Exception Handling
    try:
        # Running PlayBook(loaded play object) with TaskQueueManager
        result_test = tqm.run(play_test) 
    finally:
